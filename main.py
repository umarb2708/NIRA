...
#lcd = Adafruit_CharLCD(rs=21, en=20, d4=16, d5=12, d6=7, d7=8,cols=16, lines=2)
...
obj1=bat_status()
x=date_and_time.say_date(dt)
print (x.strftime("%H:%M"))
y=x.strftime("%H")
if y<'12':
    print "GM"
    st="Hi. Good morning umar. How are you?"
